...
FROM clock
CROSS JOIN (VALUES
    -- Deterministic, synthetic codes with the same shape as Finnish identity
    -- codes. They deliberately do not overlap with the WireMock fixture codes
    -- or with identity codes used for fresh demo requests.
    ('20000000-0000-0000-0000-000000000001'::uuid, '150385-123A', '-90 days'::interval),
    ('20000000-0000-0000-0000-000000000002'::uuid, '230476-123A', '-80 days'::interval),
    ('20000000-0000-0000-0000-000000000003'::uuid, '110682-123A', '-70 days'::interval),
    ('20000000-0000-0000-0000-000000000004'::uuid, '291195-123A', '-60 days'::interval)
...
CROSS JOIN (VALUES
    ...
    ('40000000-0000-0000-0000-000000000008'::uuid, '10000000-0000-0000-0000-000000000008'::uuid, '50000000-0000-0000-0000-000000000008'::uuid, '-12 hours'::interval, false, NULL::varchar, 1, 1, 0, '[]', '[{"currencyCode":"EUR","sum":199.00}]', '[{"loanType":"Leasing","contractDate":"2025-11-01","isLoanWithCollateral":true,"collateralType":["OtherMoveableProperty"],"borrowersCount":1,"currencyCode":"EUR","paymentPlan":{"isInDebtArrangement":false,"isInBusinessRestructuringProgram":false},"accuracyIsDenied":false,"lumpSumLoan":null,"runningAccountLoan":null,"leasingContract":{"contractPeriodStartDate":"2025-11-01","transactionPrice":18500.00},"delayedAmount":[]}]', '[]'),
    ('40000000-0000-0000-0000-000000000009'::uuid, '10000000-0000-0000-0000-000000000009'::uuid, '50000000-0000-0000-0000-000000000009'::uuid, '-18 days'::interval, false, NULL::varchar, 0, 0, 0, '[]', '[]', '[]', '[{"year":2024,"months":[{"month":12,"wagesGrossAmount":2100.00,"wagesNetAmount":1650.00,"benefitsGrossAmount":0.00,"benefitsNetAmount":0.00}]}]'),
    ('40000000-0000-0000-0000-000000000010'::uuid, '10000000-0000-0000-0000-000000000010'::uuid, '50000000-0000-0000-0000-000000000010'::uuid, '-3 days'::interval, true, 'ControlOfPersonalFinances', 0, 0, 0, '[]', '[]', '[]', '[]'),
    ('40000000-0000-0000-0000-000000000011'::uuid, '10000000-0000-0000-0000-000000000011'::uuid, '50000000-0000-0000-0000-000000000011'::uuid, '-15 days'::interval, false, NULL::varchar, 0, 0, 0, '[]', '[]', '[]', '[]'),
    ('40000000-0000-0000-0000-000000000012'::uuid, '10000000-0000-0000-0000-000000000012'::uuid, '50000000-0000-0000-0000-000000000012'::uuid, '-7 days'::interval, false, NULL::varchar, 0, 0, 0, '[]', '[]', '[]', '[]'),
    ('40000000-0000-0000-0000-000000000013'::uuid, '10000000-0000-0000-0000-000000000013'::uuid, '50000000-0000-0000-0000-000000000013'::uuid, '-25 days'::interval, true, 'Other', 1, 1, 0, '[]', '[{"currencyCode":"EUR","sum":275.00}]', '[{"loanType":"Leasing","contractDate":"2024-06-15","isLoanWithCollateral":true,"collateralType":["OtherMoveableProperty"],"borrowersCount":1,"currencyCode":"EUR","paymentPlan":{"isInDebtArrangement":false,"isInBusinessRestructuringProgram":false},"accuracyIsDenied":false,"lumpSumLoan":null,"runningAccountLoan":null,"leasingContract":{"contractPeriodStartDate":"2024-06-15","transactionPrice":22000.00},"delayedAmount":[]}]', '[]'),
